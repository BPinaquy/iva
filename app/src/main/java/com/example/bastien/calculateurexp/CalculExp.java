...
public class CalculExp extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int experience[]={0,50,50,50,50,100,100,100,100,100,150,200,250,300,350,400,450,500,550,600,700,800,900,1000,1500,2000,2500,3000,3500,4000,4500,5000,5500,6000};
        experience[0]=0;
        ...
        relative.setOnTouchListener(new OnSwipeListener(){
            ...
            public void onClick(View view) {
                ...
                for(int i =valDepart;i<valArrive;i++){
                    somme+=experience[i];
                }
